    ...
    <main className="min-h-screen bg-[#FAF9F6] bg-grid-pattern text-[#171717] font-sans selection:bg-[#c84307] selection:text-white">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {featuredProjects.map((project, idx) => (
                <FadeInView key={project.name} delay={0.06 * idx}>
                <article
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-4 md:grid-cols-3">
              {proofStats.map((item, idx) => (
                <FadeInView key={item.label} delay={0.05 * idx}>
                <article className="rounded-2xl border border-black/10 bg-white p-6 text-center">
        ...
        <section id="services" className="relative border-t border-black/10 py-24 flex flex-col items-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 w-full px-6 lg:px-12 max-w-6xl">
            {services.map((service, idx) => (
              <FadeInView key={service.title} delay={0.05 * idx}>
              <article className="p-3 bg-[#f5f5f5] rounded-[2rem] border border-black/5 flex flex-col hover:shadow-lg transition-shadow">
        ...
        <section id="faq" className="relative border-t border-black/10 py-20 px-6 lg:px-12">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-10 space-y-3">
              {faqs.map((item, idx) => (
                <FadeInView key={item.question} delay={0.03 * idx}>
      ...
      {/* Footer */}
        <footer id="contact" className="relative bg-[#171717] text-white overflow-hidden border-t border-black/10">
          ...
          <div className="px-6 pt-10 pb-8 lg:px-20 lg:pt-14 relative z-10">
            <div className="mx-auto max-w-6xl rounded-3xl border border-white/10 bg-white/[0.03] p-6 md:p-8 backdrop-blur-sm">
              <div className="flex flex-col items-start justify-between gap-8 lg:flex-row">
                <div className="max-w-xl">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#c84307]">Let&apos;s build together</p>
                  <h2 className="mt-3 text-2xl md:text-4xl font-serif font-medium tracking-tight">Ready to launch a high-converting digital presence?</h2>
                  <p className="mt-3 text-sm md:text-base text-white/75">We design and build premium web experiences for founders and teams who need speed, clarity, and execution.</p>
                </div>
              ...
              <div className="mt-7 grid gap-6 border-t border-white/10 pt-6 md:grid-cols-3">
                <div>
